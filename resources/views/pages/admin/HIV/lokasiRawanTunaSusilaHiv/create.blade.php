...
@section('title', 'Create Lok Rawan Tuna Susila HIV')
    ...
    <div class="page-content">
        ...
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.lokasi-rawan-tuna-susila-hiv.index') }}">Lok Rawan Tuna
                        Susila HIV</a></li>
                <li class="breadcrumb-item active" aria-current="page">Create Lok Rawan Tuna Susila HIV</li>
            </ol>
        </nav>
        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.lokasi-rawan-tuna-susila-hiv.store') }}" method="POST"
