...
@section('title', 'Create Penduduk Pria Produktiv HIV')
    ...
    <div class="page-content">
        ...
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.penduduk-pria-usi-produktiv-hiv.index') }}">Penduduk Pria
                        Produktiv HIV</a></li>
                <li class="breadcrumb-item active" aria-current="page">Create Penduduk Pria Produktiv HIV</li>
            </ol>
        </nav>
        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.penduduk-pria-usi-produktiv-hiv.store') }}" method="POST"
