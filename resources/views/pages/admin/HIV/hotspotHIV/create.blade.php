...
@section('title', 'Create Hotspot HIV')
    ...
    <div class="page-content">
        ...
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.hostpot-hiv.index') }}">Hotspot HIV</a></li>
                <li class="breadcrumb-item active" aria-current="page">Create Hotspot HIV</li>
            </ol>
        </nav>
        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.hostpot-hiv.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
