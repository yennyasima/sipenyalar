...
@section('title', 'Create Faskes PDP HIV')
    ...
    <div class="page-content">
        ...
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.faskes-pdp-hiv.index') }}">Faskes PDP HIV</a></li>
                <li class="breadcrumb-item active" aria-current="page">Create Faskes PDP HIV</li>
            </ol>
        </nav>
        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.faskes-pdp-hiv.store') }}" method="POST"
