...
@section('title', 'Create Wilayah Rentan HIV')
    ...
    <div class="page-content">
        ...
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.wilayah-rentan-hiv.index') }}">Wilayah Rentan HIV</a>
                </li>
                <li class="breadcrumb-item active" aria-current="page">Create Wilayah Rentan HIV</li>
            </ol>
        </nav>
        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.wilayah-rentan-hiv.store') }}" method="POST"
