...
@section('title', 'Create Kasus HIV')
    ...
    <div class="page-content">
        ...
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.news.index') }}">Kasus HIV</a></li>
                <li class="breadcrumb-item active" aria-current="page">Create Kasus HIV</li>
            </ol>
        </nav>
        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.kasus-hiv.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
