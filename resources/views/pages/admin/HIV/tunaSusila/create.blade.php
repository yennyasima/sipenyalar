...
@section('title', 'Create Tuna Sucila HIV')
    ...
    <div class="page-content">
        ...
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.tuna-susila-hiv.index') }}">Tuna Sucila HIV</a></li>
                <li class="breadcrumb-item active" aria-current="page">Create Tuna Sucila HIV</li>
            </ol>
        </nav>
        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.tuna-susila-hiv.store') }}" method="POST"
