...
@section('title', 'Create Data Penyakit ISPA')
    ...
    <div class="page-content">
        ...
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.news.index') }}">Data Penyakit ISPA</a></li>
                <li class="breadcrumb-item active" aria-current="page">Create Data Penyakit ISPA</li>
            </ol>
        </nav>
        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.data-penyakit-ispa.store') }}" method="POST"
