...
@section('title', 'Create Suhu ISPA')
    ...
    <div class="page-content">
        ...
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.news.index') }}">Suhu ISPA</a></li>
                <li class="breadcrumb-item active" aria-current="page">Create Suhu ISPA</li>
            </ol>
        </nav>
        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.suhu-ispa.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
