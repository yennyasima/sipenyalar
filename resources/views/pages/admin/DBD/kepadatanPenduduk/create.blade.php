...
@section('title', 'Create Kepadatan Penduduk DBD')
    ...
    <div class="page-content">
        ...
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.news.index') }}">Kepadatan Penduduk DBD</a></li>
                <li class="breadcrumb-item active" aria-current="page">Create Kepadatan Penduduk DBD</li>
            </ol>
        </nav>
        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.kepadatan-penduduk-dbd.store') }}" method="POST"
