...
@section('title', 'Create Data Penyakit DBD')
    ...
    <div class="page-content">
        ...
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.news.index') }}">Data Penyakit DBD</a></li>
                <li class="breadcrumb-item active" aria-current="page">Create Data Penyakit DBD</li>
            </ol>
        </nav>
        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.data-penyakit-dbd.store') }}" method="POST"
